...
const i18n = createI18n({
    ...
    messages: {
        en: {
            ...
            originalText: "My name is Andrey Samaev. I'm Web Developer with a strong VueJS and Laravel Experience as well. Experienced English-speaking Web Developer with 4+ years of commercial experience, specializing in Web Development. Skilled in direct client contact to deliver exactly what they want. Ready to take on new challenges! Let's create something amazing together!",
