<template>
  <div class="container main-bio" id="main-bio">
    ...
    <div >
      ...
      <div>
        So here's a concise summary of my 4+ yr comercial experience: 2 years of Software Information Security with Vanilla JS and Vue.js + 19 months of experience with Vue.js and Laravel with an American Healthcare product.
      </div>
      <div>
      ...
      <div>
        Experienced English-speaking Web Developer with 4+ years of comercial experience, specializing in Web Development. Skilled in direct client contact to deliver exactly what they want. Ready to take on new challenges! Let's create something amazing together!
      </div>
      <h5>
        Looking for
      </h5>
      <div>
        Currently, I'm wrapping up an exciting American CMR Project in a HealthCare with 17 months of Vue.JS / Laravel goodness and would like to keep direction which is for me like a water for a fish
      </div>
    </div>
  </div>
</template>
